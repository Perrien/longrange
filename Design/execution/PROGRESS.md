...
| 1.5b | TODO | | | bullet trace through the scope (added 2026-07-15, owner scoping question — see increment-1.md; salvage fclass `rendering/ballistics.js`; animates 1.4's TrajectoryTable over real TOF; settings-toggleable, default ON) |
