...
EMSCRIPTEN_BINDINGS(ballistics_toolkit)
{
  ...
  class_<btk::ballistics::Simulator>("BallisticsSimulator")
    ...
    .class_function("standardRetardation", &btk::ballistics::Simulator::standardRetardation);
  ...
  class_<btk::match::Simulator>("MatchSimulator")
    .constructor<const btk::ballistics::Bullet&, float, const btk::match::Target&, float, const btk::physics::Atmosphere&, float, float, float, float, float, float, float, float, float>()
  ...
  class_<btk::physics::WindGenerator>("WindGenerator")
    ...
    .function("setAdvectionMultiplier", &WindGenerator::setAdvectionMultiplier)
    .function("getAdvectionMultiplier", &WindGenerator::getAdvectionMultiplier)
  ...
  class_<btk::rendering::SteelTarget>("SteelTarget")
    ...
    .function("getAnchors", &btk::rendering::SteelTarget::getAnchorsRef, return_value_policy::reference())
    ...
    .function("setOrientation", &btk::rendering::SteelTarget::setOrientation)
    .function("getDimensions", &btk::rendering::SteelTarget::getDimensions)
    .function("isOval", &btk::rendering::SteelTarget::isOval)
  ...
  class_<btk::rendering::ImpactDetector>("ImpactDetector")
    ...
    .function("addSteelCollider", &btk::rendering::ImpactDetector::addSteelCollider, allow_raw_pointers())
